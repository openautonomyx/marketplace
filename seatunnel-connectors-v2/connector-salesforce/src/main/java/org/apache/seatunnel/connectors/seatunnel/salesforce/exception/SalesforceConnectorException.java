...
public class SalesforceConnectorException extends SeaTunnelRuntimeException {
    ...
    public SalesforceConnectorException(SeaTunnelErrorCode errorCode, String errorMessage) {
    ...
    public SalesforceConnectorException(SeaTunnelErrorCode errorCode, Throwable cause) {
